export const JOURNEY_GUIDES = {
  ...
  showcase: {
    headline: '교육 암묵지가 앱으로 변하는 순간을 바로 보여주는 시작점',
    summary: '가장 설명력이 높은 ReadMaster 시연으로 들어가고, 완료 직후에는 리포트와 다음 데모로 자연스럽게 이어집니다.',
    ctaLabel: '추천 시연 시작',
    recommendedActivityId: 'demo_readmaster',
    quickSteps: [
      { title: 'ReadMaster 열기', detail: '가장 이해가 쉬운 앱으로 바로 진입합니다.' },
      { title: '라이브 웹앱 체험', detail: '설명이 아니라 실제 화면으로 설득합니다.' },
      { title: '결과 흐름 보기', detail: '다음 앱과 리포트로 자연스럽게 이어집니다.' },
    ],
    demoOrder: [
      {
      ...
      {
        activityId: 'demo_smartstart',
        label: 'SmartStart 유아',
        presenterLine: '동기부여 설계는 교육 현장의 감각이자, 앱 안에서는 캐릭터와 흐름으로 구현됩니다.',
        audienceOutcome: '교육 감각의 인터랙션화 이해',
      },
      {
        activityId: 'demo_librainy',
        label: 'Librainy 도서관',
        presenterLine: '20년 동안 쌓인 책 추천 감각도, 좋은 데이터 조합을 만나면 하나의 플랫폼이 됩니다.',
        audienceOutcome: '생태계 수준 확장 가능성 이해',
      },
    ],
